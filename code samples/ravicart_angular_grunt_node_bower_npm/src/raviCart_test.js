...
describe('ngCart module', function() {
    ...
    describe('CartController', function() {
        ...
        beforeEach(inject(function(_$controller_){
            // before each calls everytime the test is run before each it block
            //The injector unwraps the underscores (_) from around the parameter names when matching
            $controller = _$controller_;
        }));

        describe('$scope.raviCart', function() {
            ...
            beforeEach(function() {
                $scope = {};
                //$controller from before each
                controller = $controller('CartController', {$scope: $scope});

            });
            //ngcart must be an object every time we instantiate the shopping cart 
            ...
            describe('ngCart', function() {
                ...
                beforeEach(function(){
                    ...
                    addItem(1, 'Chocolate 1', 189.99, 1);
                    addItem(2, 'Chocolate 2', 85, 2);
                    addItem('raviChocolate', 'Chocolate 3', 499.95, 1);
                });
                ...
                it('Have correct totalCost', function() {
                    ...
                    expect($scope.ngCart.totalCost()).toEqual(859.94);
                });


                it('find item by id (by int) ', function() {
                    expect($scope.ngCart.getItemById(2).getName()).toEqual('Chocolate 2');
                });


                it('find item by id (by string) ', function() {
                    expect($scope.ngCart.getItemById('raviChocolate').getName()).toEqual('Chocolate 3');
                });


                it('remove item by ID', function() {
                    $scope.ngCart.removeItemById('raviChocolate');
                    expect($scope.ngCart.getItemById('raviChocolate')).toEqual(false);
                ...
                it('should create an object', function() {
                    ...
                    expect(obj.totalCost).toEqual( 859.94 );
            ...
            describe('ngCartItem', function() {
                ...
                beforeEach(function(){
                    addItem('chocolate5', 'chocolate #5', 39.99);
                    ngCartItem = $scope.ngCart.getItemById('chocolate5');
                });


                it('should have correct Name', function() {
                    expect(ngCartItem.getName()).toEqual('chocolate #5');
                });
                ...
                it('should create an object', function() {
                    ...
                    expect(obj.id).toEqual( 'chocolate5' );
                    expect(obj.name).toEqual( 'chocolate #5' );
